...
\begin{document}
    \def\major{{"C", "C$\sharp$/D$\flat$", "D", "D$\sharp$/E$\flat$", "E", "F", "F$\sharp$/G$\flat$", "G", "G$\sharp$/A$\flat$", "A", "A$\sharp$/B$\flat$", "B"}}
    \def\minor{{"a", "a$\sharp$/b$\flat$", "b", "c", "c$\sharp$/d$\flat$", "d", "d$\sharp$/e$\flat$", "f", "f$\sharp$/g$\flat$", "g$\sharp$/a$\flat$", "a", "a$\sharp$/b$\flat$"}}
